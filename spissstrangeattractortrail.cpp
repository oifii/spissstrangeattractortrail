...
// spissstrangeattractortrail.cpp : Defines the entry point for the console application.
		...
		*/
		...
		glBegin(GL_POINTS);
			...
			//for (int i = 0; i<10; i++) 
			{
				...
				global_GLFont.TextOut("Test", x/0.02,y/0.02,0);
		...
		//global_GLFont.Begin();
		glScalef(0.02, 0.02, 0.02);
		//global_GLFont.TextOut("Test", -2.0,-2.0,0);
		//global_GLFont.TextOut("Test", -1.0/0.02,-1.0/0.02,0);
		global_GLFont.TextOut("Test", x/0.02,y/0.02,0);
		//glDisable(GL_TEXTURE_2D);
        //glPopMatrix();
		glColor4f(1.0f, 1.0f, 1.0f, 1.0f); //white
